...
#        Position
    ...
    @property
    def mygoal(self):
       return  Vector2D((-1+self.id_team)*settings.GAME_WIDTH,settings.GAME_HEIGHT/2.)
    ...
    """def entreBalletBut(self):
       vbg=Vector2D(self.mygoal,self.ball_position)
       vbg=Vector2D(self.mygoal,self.my_position)
